...
- [netsurf-base-reMarkable](https://github.com/MaicroNotHard/netsurf-base-reMarkable): fork of netsurf, with modifications to make it work better on the reMarkable
